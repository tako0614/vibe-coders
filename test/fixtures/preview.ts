...
const { app, websocket } = createHttp(runtime, { devOrigin: 'http://127.0.0.1:5173' });
const closeDesktop =
...
console.log('Isolated preview API on 3100; fixture account owner / test-only-password-123');

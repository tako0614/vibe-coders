...
RUN apt-get update && apt-get install -y --no-install-recommends git openssh-client poppler-utils xdotool imagemagick ca-certificates && rm -rf /var/lib/apt/lists/*
